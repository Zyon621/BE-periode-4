    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                @if (Auth::check() && in_array(Auth::user()->rolename, ['tandarts']))
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                ...
                @if (Auth::check() && in_array(Auth::user()->rolename, ['mondhygienist']))
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                ...
                @if (Auth::check() && in_array(Auth::user()->rolename, ['assistent']))
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
